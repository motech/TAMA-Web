...
public class FourDayRecallAdherenceServiceTest {
    ...
    public void setUp() {
        ...
        fourDayRecallAdherenceService = new FourDayRecallAdherenceService(allWeeklyAdherenceLogs, allPatients, allTreatmentAdvices, fourDayRecallService, properties, new AdherenceService());
    }
