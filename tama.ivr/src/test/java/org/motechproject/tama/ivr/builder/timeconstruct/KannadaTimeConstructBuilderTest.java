...
public class KannadaTimeConstructBuilderTest {
    ...
    public void shouldCreateTimeConstruct_AtMidnight_Start() {
        ...
        List<String> timeConstructWAVs = new KannadaTimeConstructBuilder().build(midnight);
    ...
    public void shouldCreateTimeConstruct_AtEarlyMorning_Start() {
        ...
        List<String> timeConstructWAVs = new KannadaTimeConstructBuilder().build(earlyMorning);
        assertEquals(5, timeConstructWAVs.size());
    ...
    public void shouldCreateTimeConstruct_AtMorning_Start() {
        ...
        List<String> timeConstructWAVs = new KannadaTimeConstructBuilder().build(morning);
        assertEquals(5, timeConstructWAVs.size());
    ...
    public void shouldCreateTimeConstruct_AtNoon_Start() {
        ...
        List<String> timeConstructWAVs = new KannadaTimeConstructBuilder().build(noon);
        assertEquals(3, timeConstructWAVs.size());
    ...
    public void shouldCreateTimeConstruct_AtEvening_Start() {
        ...
        List<String> timeConstructWAVs = new KannadaTimeConstructBuilder().build(evening);
        assertEquals(3, timeConstructWAVs.size());
    ...
    public void shouldCreateTimeConstruct_AtNight_Start() {
        ...
        List<String> timeConstructWAVs = new KannadaTimeConstructBuilder().build(night);
        assertEquals(5, timeConstructWAVs.size());
