...
public class CurrentDosageConfirmTest extends BaseIVRTest {
    ...
    public void outboxFlow_WhenPatient_CallsTAMA() throws IOException {
        ...
        IVRAssert.asksForCollectDtmfWith(ivrResponse, DEFAULT_INBOUND_CLINIC_MESSAGE, DOSE_TAKEN_MENU_OPTION, SYMPTOMS_REPORTING_MENU_OPTION);
        ...
        ivrResponse = caller.listenMore();
        IVRAssert.asksForCollectDtmfWith(ivrResponse, DOSE_TAKEN_MENU_OPTION, SYMPTOMS_REPORTING_MENU_OPTION);
