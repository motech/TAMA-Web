...
public class Regimen4Test_LowHBCount_NoPsychiatricIllness extends SpringIntegrationTest {
    ...
    @Before
    public void setUp() {
        medicalConditionsCase1 = MedicalConditionBuilder.startRecording().ForRegimen4().Male().LowBaselineHBCount().NoHistoryOfPsychiatricIllness().build();
    }
    ...
    private void assertOnHighCD4Count(MedicalCondition medicalCondition) {
        ...
        assertEquals("Regimen4_2", symptomReportingService.getSymptomReportingTree(medicalCondition));
    }
}
