...
public class EditPatientIdInCallLogsDoc extends AllCallLogs{
	...
	private static final Logger LOGGER = Logger.getLogger(EditPatientIdInCallLogsDoc.class);
	@Autowired
	protected EditPatientIdInCallLogsDoc(@Qualifier("tamaDbConnector")CouchDbConnector db) {
		super(db);
