...
public class MyDosageResponse extends DosageResponse {

    private final DosageResponse dosageResponse;

    private final LocalDate dosageDate;

    public MyDosageResponse(DosageResponse dosageResponse, LocalDate dosageDate) {
    ...
    public boolean equals(Object o) {
        ...
        MyDosageResponse that = (MyDosageResponse) o;
