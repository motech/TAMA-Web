dojo.addOnLoad(function() {
    ...
    var validateLabResults = function() {
        var labResult1TestDate = dojo.byId("_labResults[0].testDateAsDate_id");
        var labResult2TestDate = dojo.byId("_labResults[1].testDateAsDate_id");
        var labResult1TestResult = dojo.byId("_labResults[0].result_id");
        var labResult2TestResult = dojo.byId("_labResults[1].result_id");
        ...
        var conditions = [
            {
                ...
                message : "You must enter both test date and test result.<br/>(Unset test date and test result values to delete the record.)"
            },
            {
                execute: function() {
    ...
    dojo.connect(dojo.byId("labResultsUIModel"), "onsubmit", function(evt) {
