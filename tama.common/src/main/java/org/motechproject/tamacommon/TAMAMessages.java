...
public class TAMAMessages {
    ...
    public static final String PASSCODE_REGEX_MESSAGE = "Passcode should be numeric and 4 digits long.";
    ...
    public static final String NEW_PASSWORD_MISMATCH = "The values in the new password and confirm new password fields should match.";
