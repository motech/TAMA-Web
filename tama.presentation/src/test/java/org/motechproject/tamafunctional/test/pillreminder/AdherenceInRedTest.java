...
public class AdherenceInRedTest extends BaseIVRTest {
    ...
    public void shouldRaise_RedAlert_WhenAdherenceFalls_Below70Percent() throws IOException {
        ...
        assertAudioFilesPresent(ivrResponse, MISSED_PILL_FEEDBACK_LESS_THAN_70, DOSE_CANNOT_BE_TAKEN_MENU);
        ivrResponse = caller.enter("2");
        assertAudioFilesPresent(ivrResponse, PLEASE_CARRY_SMALL_BOX, YOUR_ADHERENCE_IS_NOW, "Num_000", PERCENT);
    }
}
