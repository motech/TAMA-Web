...
public class IncompletePatientDataWarning {
    ...
    private void findAllRequiredInfo(){
        VitalStatistics vitalStatistics = allVitalStatistics.findByPatientId(patient.getId());
    ...
    public String toString(){
        ...
        if (pendingPatientDetailsArray.isEmpty())
            return null;
        return "Please fill in the " + StringUtils.join(pendingPatientDetailsArray, ", ") + " for the patient";
    }
}
