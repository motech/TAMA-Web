package org.motechproject.tama.service.symptomreportingservice.regimen3;
...
public class Regimen3Test_LowHBCount extends SpringIntegrationTest {
    ...
    @Before
    public void setUp() {
        medicalConditionsCase1 = MedicalConditionBuilder.startRecording().ForRegimen3().Male().LowBaselineHBCount().build();
    }
    ...
    private void assertOnLowCD4Count(MedicalCondition medicalCondition) {
        ...
        assertEquals("Regimen3_1", symptomReportingService.getSymptomReportingTree(medicalCondition));
    }

    private void assertOnHighCD4Count(MedicalCondition medicalCondition) {
        medicalCondition.cd4Count(60);
        assertEquals("Regimen3_2", symptomReportingService.getSymptomReportingTree(medicalCondition));
    }
}
