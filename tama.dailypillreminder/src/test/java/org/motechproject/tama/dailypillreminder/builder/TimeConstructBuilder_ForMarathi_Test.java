...
public class TimeConstructBuilder_ForMarathi_Test {
    ...
    public void shouldCreateTimeConstruct_AtMidnight_Start() {
        ...
        List<String> timeConstructWAVs = new TimeConstructBuilder().build(IVRLanguage.MARATHI_CODE, midnight);
    ...
    public void shouldCreateTimeConstruct_AtEarlyMorning_Start() {
        ...
        List<String> timeConstructWAVs = new TimeConstructBuilder().build(IVRLanguage.MARATHI_CODE, earlyMorning);
        assertEquals(5, timeConstructWAVs.size());
    ...
    public void shouldCreateTimeConstruct_AtMorning_Start() {
        ...
        List<String> timeConstructWAVs = new TimeConstructBuilder().build(IVRLanguage.MARATHI_CODE, morning);
        assertEquals(3, timeConstructWAVs.size());
    ...
    public void shouldCreateTimeConstruct_AtNoon_Start() {
        ...
        List<String> timeConstructWAVs = new TimeConstructBuilder().build(IVRLanguage.MARATHI_CODE, noon);
        assertEquals(3, timeConstructWAVs.size());
    ...
    public void shouldCreateTimeConstruct_AtEvening_Start() {
        ...
        List<String> timeConstructWAVs = new TimeConstructBuilder().build(IVRLanguage.MARATHI_CODE, evening);
        assertEquals(5, timeConstructWAVs.size());
    ...
    public void shouldCreateTimeConstruct_AtNight_Start() {
        ...
        List<String> timeConstructWAVs = new TimeConstructBuilder().build(IVRLanguage.MARATHI_CODE, night);
        assertEquals(5, timeConstructWAVs.size());
