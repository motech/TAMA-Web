...
public class Regimen2Test_NoPsychiatricIllness_And_NoMedicalCondition extends SpringIntegrationTest {
    ...
    @Before
    public void setUp() {
        medicalConditionsCase1 = MedicalConditionBuilder.startRecording().ForRegimen2().Male().NoHistoryOfPsychiatricIllness().AboveMiddleAge().HistoryOfNephrotoxicMedication().AdviceIsWithin6Months().build();
        medicalConditionsCase2 = MedicalConditionBuilder.startRecording().ForRegimen2().Male().NoHistoryOfPsychiatricIllness().AboveMiddleAge().NoHistoryOfMedicalConditions().AdviceIsWithin6And12Months().build();
        medicalConditionsCase3 = MedicalConditionBuilder.startRecording().ForRegimen2().Male().NoHistoryOfPsychiatricIllness().AboveMiddleAge().NoHistoryOfMedicalConditions().AdviceIsWithin6Months().build();

        medicalConditionsCase4 = MedicalConditionBuilder.startRecording().ForRegimen2().Male().NoHistoryOfPsychiatricIllness().BelowMiddleAge().HistoryOfNephrotoxicMedication().AdviceIsWithin6And12Months().build();
        medicalConditionsCase5 = MedicalConditionBuilder.startRecording().ForRegimen2().Male().NoHistoryOfPsychiatricIllness().BelowMiddleAge().HistoryOfNephrotoxicMedication().AdviceIsWithin6Months().build();
        medicalConditionsCase6 = MedicalConditionBuilder.startRecording().ForRegimen2().Male().NoHistoryOfPsychiatricIllness().BelowMiddleAge().NoHistoryOfMedicalConditions().AdviceIsWithin6And12Months().build();
        medicalConditionsCase7 = MedicalConditionBuilder.startRecording().ForRegimen2().Male().NoHistoryOfPsychiatricIllness().BelowMiddleAge().NoHistoryOfMedicalConditions().AdviceIsWithin6Months().build();
    }
    ...
    private void assertOnLowCD4Count(MedicalCondition medicalCondition) {
        ...
        assertEquals("Regimen2_1", symptomReportingService.getSymptomReportingTree(medicalCondition));
    }
