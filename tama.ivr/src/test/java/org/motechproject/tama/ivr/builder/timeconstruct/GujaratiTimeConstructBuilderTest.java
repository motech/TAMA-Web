...
public class GujaratiTimeConstructBuilderTest {

    @Test
    // 0:0:0 - Midnight Start
    public void shouldCreateTimeConstruct_AtMidnight_Start() {
        LocalTime midnight = new LocalTime(0, 0, 0);
        List<String> timeConstructWAVs = new GujaratiTimeConstructBuilder().build(midnight);
    ...
    public void shouldCreateTimeConstruct_AtEarlyMorning_Start() {
        ...
        List<String> timeConstructWAVs = new GujaratiTimeConstructBuilder().build(earlyMorning);
        assertEquals(5, timeConstructWAVs.size());
    ...
    public void shouldCreateTimeConstruct_AtMorning_Start() {
        ...
        List<String> timeConstructWAVs = new GujaratiTimeConstructBuilder().build(morning);
        assertEquals(3, timeConstructWAVs.size());
    ...
    public void shouldCreateTimeConstruct_AtNoon_Start() {
        ...
        List<String> timeConstructWAVs = new GujaratiTimeConstructBuilder().build(noon);
        assertEquals(3, timeConstructWAVs.size());
    ...
    public void shouldCreateTimeConstruct_AtEvening_Start() {
        ...
        List<String> timeConstructWAVs = new GujaratiTimeConstructBuilder().build(evening);
        assertEquals(5, timeConstructWAVs.size());
    ...
    public void shouldCreateTimeConstruct_AtNight_Start() {
        ...
        List<String> timeConstructWAVs = new GujaratiTimeConstructBuilder().build(night);
        assertEquals(5, timeConstructWAVs.size());
