...
public class AlertFilterTest {
    ...
    public void shouldReturnAllAlertStatuses() {
        ...
        assertEquals(AlertFilter.STATUS_ALL, allAlertStatuses.get(0));
        assertEquals(AlertFilter.STATUS_OPEN, allAlertStatuses.get(1));
        assertEquals(AlertFilter.STATUS_CLOSED, allAlertStatuses.get(2));
    }
