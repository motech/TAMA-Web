...
<input type="checkbox" id="poll_call" checked="true"></input> Accept incoming call
    ...
    <table id="params">
        ...
        <tr>
            <td>PIN</td>
            <td><input type="text" id="pin" value="1111"/></td>
        </tr>
        <tr class="optional">
            <td>Dosage Id</td>
            <td><input type="text" id="dosage_id" value=""/></td>
            <td>from couch db :motech-pillreminder (uuid something like 1d3d5270-9229-4ff8-95e7-1a93e6c6a6c6)</td>
        </tr>
        <tr class="optional">
            <td>Regimen Id</td>
            <td><input type="text" id="regimen_id" value=""/></td>
            <td>from couch db :motech-pillreminder (uuid)</td>
        </tr>
        <tr class="optional">
        ...
        <tr class="optional">
            <td>Total retries</td>
            <td><input type="text" id="total" value="3"/></td>
        </tr>
        <tr class="optional">
            <td>call id</td>
        ...
        <tr class="optional">
            <td>outbox call</td>
            <td><input type="checkbox" id="outbox_call" value="false"/></td>
        </tr>
        <tr>
