...
public class TeluguTimeConstructBuilderTest {
    ...
    public void shouldCreateTimeConstruct_AtMorning_Start() {
        ...
        List<String> timeConstructWAVs = new TeluguTimeConstructBuilder().build(morning);
        assertEquals(5, timeConstructWAVs.size());
    ...
    public void shouldCreateTimeConstruct_AtNoon_Start() {
        ...
        List<String> timeConstructWAVs = new TeluguTimeConstructBuilder().build(noon);
        assertEquals(3, timeConstructWAVs.size());
