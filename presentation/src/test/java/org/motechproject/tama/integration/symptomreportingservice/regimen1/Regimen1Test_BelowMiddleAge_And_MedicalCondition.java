package org.motechproject.tama.integration.symptomreportingservice.regimen1;
...
public class Regimen1Test_BelowMiddleAge_And_MedicalCondition extends SpringIntegrationTest {
    ...
    @Before
    public void setUp() {
        medicalConditionsCase1 = MedicalConditionBuilder.startRecording().ForRegimen1().Male().BelowMiddleAge().HistoryOfDiabetes().AdviceIsWithin6And12Months().build();
    }
