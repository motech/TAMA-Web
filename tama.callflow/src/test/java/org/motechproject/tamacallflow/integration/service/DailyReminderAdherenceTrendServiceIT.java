...
public class DailyReminderAdherenceTrendServiceIT extends SpringIntegrationTest {
    ...
    public void setUp() {
        initMocks(this);
        dailyReminderAdherenceTrendService = new DailyReminderAdherenceTrendService(allDosageAdherenceLogs, pillReminderService, patientAlertService);
    }
    ...
    public void adherenceTrendIsFallingWhenAdherenceTodayIsLessThanAdherenceOnLastWeek_SingleDoseRegimen(){
        ...
        assertTrue(dailyReminderAdherenceTrendService.isAdherenceFalling("patientId"));
    }
    ...
    public void adherenceTrendIsNotFallingWhenAdherenceTodayIsNotLessThanAdherenceOnLastWeek_SingleDoseRegimen(){
        ...
        assertFalse(dailyReminderAdherenceTrendService.isAdherenceFalling("patientId"));
    }
