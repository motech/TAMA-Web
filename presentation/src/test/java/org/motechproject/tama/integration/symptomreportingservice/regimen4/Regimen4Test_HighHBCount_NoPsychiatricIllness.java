...
public class Regimen4Test_HighHBCount_NoPsychiatricIllness extends SpringIntegrationTest {
    ...
    @Before
    public void setUp() {
        medicalConditionsCase1 = MedicalConditionBuilder.startRecording().ForRegimen4().Male().HighBaselineHBCount().NoHistoryOfPsychiatricIllness().build();
    }
    ...
    private void assertOnLowCD4Count(MedicalCondition medicalCondition) {
        ...
        assertEquals("Regimen4_5", symptomReportingService.getSymptomReportingTree(medicalCondition));
    }
