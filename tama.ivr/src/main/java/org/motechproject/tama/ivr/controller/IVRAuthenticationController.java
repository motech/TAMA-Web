...
import org.motechproject.tama.ivr.service.AuthenticationService;
import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.stereotype.Controller;
import org.springframework.web.bind.annotation.RequestMapping;

@Controller
@RequestMapping(ControllerURLs.AUTHENTICATION_URL)
public class IVRAuthenticationController extends SafeIVRController {
    ...
    public KookooIVRResponseBuilder gotDTMF(KooKooIVRContext kooKooIVRContext) {
        ...
        String callId = tamaivrContext.callId();
        System.out.println("TAMAIVR CONTECT OUT GOING CALL :"+tamaivrContext.isOutgoingCall());
